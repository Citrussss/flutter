...
articleListEntityFromJson(ArticleListEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new ArticleListData().fromJson(json['data']);
	}
...
articleListDataFromJson(ArticleListData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = new List<ArticleListDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new ArticleListDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
articleListDataDataFromJson(ArticleListDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> articleListDataDataToJson(ArticleListDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
